...
public class InactiveEmployeValidator {

    /*

    */

    public static List<String> validate(InactiveEmployeDto employeDto){
        ...
        if(employeDto == null){
            ...
            errors.add("Le champ depart year est obligatoire !");
        }
        ...
        if(employeDto.getDepartYear() == null){
            errors.add("Le champ depart year est obligatoire !");
        }
        return errors;
    }
